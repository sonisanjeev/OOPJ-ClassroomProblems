...
public class LibraryBookTest {
    public static void main(String[] args) {
         Books b1 = new Books("Java Basics", "J. Author", 350.0, "ISBN001");
        Books b2 = new Books("OOP Concepts", "K. Writer", 420.0, "ISBN002");
 
        System.out.println(b1.getTitle() + " by " + b1.getAuthor());
        System.out.println("Price: " + b2.getPrice());
        System.out.println("Library: " + Books.libraryName);
        System.out.println("Total books added: " + Books.bookCount);
    }
